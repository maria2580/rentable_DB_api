...
public class Test_Controller {
    ...
    public String testController(){
        try{
            ...
            con.createStatement().execute("create table if not exists items_uploaded (index int, uoload_user_id varchar(20),title varchar(80),content text, uploaded_date_time varchar(20), is_deleted boolean, reservation_table_name varchar(50), comment_table_name varchar(50), reviews_table_name varchar(50));");
            ...
            con.createStatement().execute("create table if not exists profile_images (index int, uploader_user_id varchar(20), Path varchar(200), uploaded_date_time varchar(20));");
